...
b4w.register("nmp_visdev_main", function(exports, require) {
...
function load() {
    ...
    m_data.load(APP_ASSETS_PATH + "litaya_26_bw-splash_L18126i_hor_anim.json", load_cb, preloader_cb);
}
...
b4w.require("nmp_visdev_main").init();
